                        ...
                        {/* <div style={{ maxHeight: "70vh", overflow: "scroll" }}> */}
                            ...
                            {/* <MDBContainer fluid> */}
                                ...
                                <MDBCol className="awsServices" sm="3" md="3" lg="3" >
                                    <MDBRow className="serviceCard">
                                        <MDBCol sm="3" md="3" lg="3" >
                                            <img className="alignleft" src="https://cdn.mos.cms.futurecdn.net/SDDw7CnuoUGax6x9mTo7dd.jpg" alt="AWS Lambda" width={"70vw"} />
                                        </MDBCol>
                                ...
                                <MDBCol className="awsServices" sm="3" md="3" lg="3" >
                                    <MDBRow className="serviceCard">
                                        <MDBCol sm="3" md="3" lg="3" >
                                            <img className="alignleft" src="https://gobrolly.com/wp-content/uploads/2020/08/microsoft-teams-logoV2.png" alt="AWS Lambda" width={"70vw"} />
                                        </MDBCol>
                                        <MDBCol sm="9" md="9" lg="9" >
                                            <div className="alertSystem" style={{ display: "inherit !important" }} >
